...
#Initialization of hidden units,number of random 
#initialization seeds and number of epochs
num_epochs = 500
ini = 1
numhid = 100
...
np.savetxt('W_autoencoder.txt',w1,delimiter=',')   
#w1 visualized with MATLAB as montage
